...
(function (factory) {
        ...
        this.insertImages = function (files) {
            $.each(files, function (idx, file) {
                ...
                if (options.maximumImageFileSize && options.maximumImageFileSize < file.size) {
                    ...
                    var insertImageHandler = self.insertImage;
                    //改造成上传文件形式
                    var formData = new FormData();
                    formData.append("file", file);
                    $.ajax({
                        url: options.basePath + options.uploadPath,
                        type: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
                        success: function (data) {
                            if (data.success) {
                                ...
                                insertImageHandler(file.uploadPrefixPath + file.path, file.original);
                            } else {
                                alert("文件上传失败");
                            }
                        },
    ...
    $.summernote = $.extend($.summernote, {
        ...
        options: {
            ...
            basePath: ns.getBasePath(),
            uploadPath: "/common/upload/do",
