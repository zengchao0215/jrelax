...
// eg: `data-parsley-stop-on-first-failing-constraint="false"`
  var ParsleyDefaults = {
    ...
    errorClass2: 'has-error',
    // Same for success validation
    successClass: 'parsley-success',
    successClass2: 'has-success',
    ...
    errorsWrapper: '<ul class="parsley-errors-list no-m"></ul>',
  ...
  */
  ...
  ParsleyUI.prototype = {
    ...
    addError: function (fieldInstance, name, message, assert, doNotUpdateClass) {
        ...
        var placement = element.attr("data-parsley-placement") || "top";
	    //兼容chonse 下拉框
	    if(element.parent().find(".chosen-container").length > 0){
	    	element = element.parent().find(".chosen-container .chosen-choices");
	    }
    	element.tooltip({title:(message || this._getErrorMessage(fieldInstance, assert)), placement:placement});
    ...
    updateError: function (fieldInstance, name, message, assert, doNotUpdateClass) {
    	//fieldInstance.$element.tooltip("destory");
    	var element = fieldInstance.$element;
        var placement = element.attr("data-parsley-placement") || "top";
	    //兼容chonse 下拉框
	    if(element.parent().find(".chosen-container").length > 0){
    ...
    _insertErrorWrapper: function (fieldInstance) {
      ...
      if('undefined' === typeof fieldInstance.options.multiple){
    	  if(fieldInstance.$element.attr("class") != undefined && fieldInstance.$element.attr("class").indexOf("chosen") >= 0)
    ...
    _successClass: function (fieldInstance) {
      ...
      fieldInstance._ui.$errorClassHandler.parent().removeClass(fieldInstance.options.errorClass2).addClass(fieldInstance.options.successClass2);
    },
    _errorClass: function (fieldInstance) {
      fieldInstance._ui.validationInformationVisible = true;
      fieldInstance._ui.$errorClassHandler.parent().removeClass(fieldInstance.options.successClass2).addClass(fieldInstance.options.errorClass2);
