  ...
  ParsleyUI.Field = {
    ...
    _addError: function _addError(name, _ref5) {
      ...
      // this._ui.$errorsWrapper.addClass('filled').append($(this.options.errorTemplate).addClass('parsley-' + name).html(message || this._getErrorMessage(assert)));
        ...
        element.tooltip({title:(message || this._getErrorMessage(assert)), placement:placement});
    ...
    _successClass: function _successClass() {
      ...
      this._ui.$errorClassHandler.parent().removeClass(this.options.errorClass2).addClass(this.options.successClass2);
    },
      //change: 兼容Bootstrap
    _errorClass: function _errorClass() {
      this._ui.validationInformationVisible = true;
      // this._ui.$errorClassHandler.removeClass(this.options.successClass).addClass(this.options.errorClass);
      this._ui.$errorClassHandler.parent().removeClass(this.options.successClass2).addClass(this.options.errorClass2);
    },
      //change: 兼容Bootstrap
    _resetClass: function _resetClass() {
      // this._ui.$errorClassHandler.removeClass(this.options.successClass).removeClass(this.options.errorClass);
      this._ui.$errorClassHandler.parent().removeClass(this.options.successClass2).removeClass(this.options.errorClass2);
    }
  };
