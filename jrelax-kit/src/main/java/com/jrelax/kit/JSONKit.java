...
public class JSONKit {
     ...
     * @return
     */
    public static JSONObject fromObject(Object object, String[] fields){
        JSONObject json = new JSONObject();
        for(String field : fields){
            json.element(field, ReflectKit.getFieldValue(object, field));
        }
        return json;
    }
     ...
     * @return
     */
    public static JSONArray fromList(List<?> list , String[] fields){
        JSONArray array = new JSONArray();
        for(Object obj : list){
            array.add(fromObject(obj, fields));
        }
        return array;
    }
}
